...
const Footer = (props: Props) => {
  return (
    <div className="bg-[#0A0702]  pt-12 md:pt-20">
        ...
        <div className="relative bottom-10  pt-28 md:pt-32 md:pb-1  text-white">
          <div className="grid grid-cols-1 md:grid-cols-4  md:justify-start items-start content-start   ">
            <div className="px-10 pb-4">
              <h1 className="font-poppins font-bold text-xl md:text-3xl md:mb-4">
                Roundtable
              </h1>
              <div className="md:text-xl">
                The Official Skill Development Society,
                <br />
            ...
            <div className="px-10 py-4 md:py-0">
              <h1 className="font-poppins font-bold text-xl md:text-3xl">
                Follow Us
              </h1>
            ...
            <div className="px-10">
              ...
              <h4 className="py-1 md:text-xl">
                Saksham Checker (President){" "}
                <span className="block">9013844884</span>
              </h4>
              <h4 className="py-1 md:text-xl">
                Saksham Gupta (Vice President){" "}
                <span className="block">9643717655</span>
              </h4>
            </div>
          </div>
        </div>
